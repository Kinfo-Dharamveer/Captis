...
import com.captis.xboxmodule.utilities.OAuth;
import com.captis.xboxmodule.utilities.OAuthSuccessfulResponse;
...
public class LiveConnectSession {
    ...
    public boolean contains(Iterable<String> scopes) {
        if (scopes == null) {
            return true;
     ...
     */
    public void loadFromOAuthResponse(OAuthSuccessfulResponse response) {
    ...
    public boolean willExpireInSecs(int secs) {
        final Calendar calendar = Calendar.getInstance();
